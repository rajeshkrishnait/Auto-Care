...
public class Custdetail extends ViewAllin {
    ...
    Custdetail(){
        ...
        l_userid.setBounds(780,200,80,40);
        p6.add(l_userid);
        ...
        blockuser.setBounds(800,250,150,40);
        p6.add(blockuser);
...
//class finding the number of records in a DataBase Table
    ...
    public class ShowTable {
        ...
        ShowTable(){
            ...
            String [] heading = {"userid","name","username","passwords","mobileno","address1","address2","district","state","pincode"};
            ...
            try {
                ...
                while(rs.next()) {
                    ...
                    data[row][3] = rs.getString("passwords");
                    data[row][4] = rs.getString("mobileno");
                    data[row][5] = rs.getString("addrees1");
                    data[row][6] = rs.getString("address2");
                    data[row][7] = rs.getString("district");
                    data[row][8] = rs.getString("state");
                    data[row][9] = rs.getString("pincode");
                    row++;
                }
                jt1 = new JTable(data,heading);
                jt1.setBounds(10,30,750,500);
                JScrollPane jsp = new JScrollPane(jt1);
                jsp.setBounds(10,38,764,512);
